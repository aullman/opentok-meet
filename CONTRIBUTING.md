...
Server-side contributions should use the simple plugin architecture. All related files should be included in a separate folder in the [plugins](plugins/) directory. This makes it easy for people forking the project to opt out of including your plugin and also makes it easy to merge without conflicts.

Similarly client-side contributions should be kept as separate as possible. Try to use angular directives and put as much code as possible in separate files. The CSS, HTML should be kept separate and included using a require statement. The tests should also be included in separate files.
